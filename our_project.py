...
if selection == "Home Page":
        ...
        df.head()
        st.header("In case you would like to view the data set,[ Click right here!](https://www.kaggle.com/datasets/catherinerasgaitis/mxmh-survey-results)")
        st.markdown("## Columns")
        df.columns
    ...
    st.image("assumptions.jpg")
        ...
        st.header("Below are our conclusions")
